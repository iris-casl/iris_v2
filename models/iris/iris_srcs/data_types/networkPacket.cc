...
{
    /*! This function is necessary if you use the Send api to send a packet
    across LP boundaries. 
    If you want to use Send but are sure to not cross the LP boundary you can
    leave a stub for compilation. It will never get called. 
    If you want to cross an LP boundary an example of how to serialize is in
    linkData.cc
    */
    return 0;
}
...
NetworkPacket:: Deserialize(const unsigned char* data, int len)
{
    ...
    If you want to use Send but are sure to not cross the LP boundary you can
    leave a stub for compilation. It will never get called. 
    If you want to cross an LP boundary an example of how to deserialize is in
    linkData.cc
    */
    NetworkPacket p;
    return p;
